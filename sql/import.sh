...
curl -X POST "http://$HTTP_API_URL/v1/Game/SyncToRedis" -H  "accept: application/json" -H  "APIKey: $HTTP_API_KEY"
curl -X POST "http://$HTTP_API_URL/v1/Group/SyncToRedis" -H  "accept: application/json" -H  "APIKey: $HTTP_API_KEY"